    ...
    try:
        with tempfile.TemporaryDirectory() as td:
            ...
            with open(pathlib.Path(input_path), "rb") as inputfile:
                ...
                width, height = utils.calculate_offset(reader.getPage(1))  # first page (getPage(0)) may contain overview
                input_papersize = utils.PaperSize(width=width, height=height)
