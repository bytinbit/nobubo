...
def test_no_overview_normal_collage(testdata, tmp_path, pdftester):
    ...
    runner = CliRunner()
    result = runner.invoke(cli.main, ["--il", "1", "8", "4", str(filepath), str(output_filepath)])
    print(result.output)
...
def test_no_overview_reverse_collage(testdata, tmp_path, pdftester):
    ...
    output_filepath = tmp_path / "mock.pdf"
    runner = CliRunner()
    result = runner.invoke(cli.main, ["--il", "1", "8", "4", "--reverse", str(filepath), str(output_filepath)])
    print(result.output)
    assert result.exit_code == 0
    assert pdftester.read() == ["mock_1.pdf"]
...
def test_one_overview_normal_collage(testdata, tmp_path, pdftester):
    ...
    output_filepath = tmp_path / "mock.pdf"
    runner = CliRunner()
    result = runner.invoke(cli.main, ["--il", "2", "8", "4", str(filepath), str(output_filepath)])
    print(result.output)
    assert result.exit_code == 0
    assert pdftester.read() == ["mock_1.pdf"]
...
def test_one_overview_reverse_collage(testdata, tmp_path, pdftester):
    ...
    output_filepath = tmp_path / "mock.pdf"
    runner = CliRunner()
    result = runner.invoke(cli.main, ["--il", "2", "8", "4", "--reverse", str(filepath), str(output_filepath)])
    print(result.output)
    assert result.exit_code == 0
    assert pdftester.read() == ["mock_1.pdf"]
...
def test_two_overviews_normal_collage(testdata, tmp_path, pdftester):
    ...
    output_filepath = tmp_path / "mock.pdf"
    runner = CliRunner()
    result = runner.invoke(cli.main, ["--il", "2", "8", "4", "--il", "35", "7", "3", str(filepath), str(output_filepath)])
    print(result.output)
    assert result.exit_code == 0
...
def test_two_overviews_reverse_collage(testdata, tmp_path, pdftester):
    ...
    output_filepath = tmp_path / "mock.pdf"
    runner = CliRunner()
    result = runner.invoke(cli.main, ["--il", "2", "8", "4", "--il", "35", "7", "3", "--reverse", str(filepath), str(output_filepath)])
    print(result.output)
    assert result.exit_code == 0
    assert pdftester.read() == ["mock_1.pdf", "mock_2.pdf"]
...
def test_one_overview_normal_a0(testdata, tmp_path, pdftester):
    ...
    output_filepath = tmp_path / "mock.pdf"
    runner = CliRunner()
    result = runner.invoke(cli.main, ["--il", "2", "8", "4", "--ol", "a0", str(filepath), str(output_filepath)])
    print(result.output)
    assert result.exit_code == 0
    assert pdftester.read() == ["mock_1.pdf"]
...
def test_one_overview_reverse_a0(testdata, tmp_path, pdftester):
    ...
    output_filepath = tmp_path / "mock.pdf"
    runner = CliRunner()
    result = runner.invoke(cli.main, ["--il", "2", "8", "4", "--ol", "a0", "--reverse", str(filepath), str(output_filepath)])
    print(result.output)
    assert result.exit_code == 0
    assert pdftester.read() == ["mock_1.pdf"]
...
def test_one_overview_normal_custom(testdata, tmp_path, pdftester):
    ...
    output_filepath = tmp_path / "mock.pdf"
    runner = CliRunner()
    result = runner.invoke(cli.main, ["--il", "2", "8", "4", "--ol", "920x1187", str(filepath), str(output_filepath)])
    print(result.output)
    assert result.exit_code == 0
    assert pdftester.read() == ["mock_1.pdf"]
...
def test_one_overview_normal_us(testdata, tmp_path, pdftester):
    ...
    output_filepath = tmp_path / "mock.pdf"
    runner = CliRunner()
    result = runner.invoke(cli.main, ["--il", "2", "8", "4", "--ol", "us", str(filepath), str(output_filepath)])
    print(result.output)
    assert result.exit_code == 0
    assert pdftester.read() == ["mock_1.pdf"]
...
def test_two_overviews_normal_a0(testdata, tmp_path, pdftester):
    ...
    output_filepath = tmp_path / "mock.pdf"
    runner = CliRunner()
    result = runner.invoke(cli.main, ["--il", "2", "8", "4", "--il", "35", "7", "3", "--ol", "a0", str(filepath), str(output_filepath)])
    print(result.output)
    assert result.exit_code == 0
    assert pdftester.read() == ["mock_1.pdf", "mock_2.pdf"]
...
def test_two_overviews_reverse_a0(testdata, tmp_path, pdftester):
    ...
    output_filepath = tmp_path / "mock.pdf"
    runner = CliRunner()
    result = runner.invoke(cli.main, ["--il", "2", "8", "4", "--il", "35", "7", "3", "--ol", "a0", "--reverse", str(filepath), str(output_filepath)])
    print(result.output)
    assert result.exit_code == 0
    assert pdftester.read() == ["mock_1.pdf", "mock_2.pdf"]
